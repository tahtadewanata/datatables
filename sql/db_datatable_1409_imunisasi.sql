...
-- Dumping database structure for datatables
CREATE DATABASE IF NOT EXISTS `datatables` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `datatables`;

-- Dumping structure for table datatables.apk
...
-- Dumping data for table datatables.apk: ~2 rows (approximately)
...
-- Dumping structure for table datatables.apm
...
-- Dumping data for table datatables.apm: ~2 rows (approximately)
...
-- Dumping structure for table datatables.balita
...
-- Dumping data for table datatables.balita: ~20 rows (approximately)
INSERT INTO `balita` (`id`, `kecamatan_id`, `jk_lk`, `jk_pr`, `tahun`, `created_at`, `updated_at`) VALUES
	(1, 1, 1320, 1291, 2021, '2023-09-15 20:31:01', '2023-09-15 20:31:02'),
	(2, 2, 1256, 1218, 2021, '2023-09-15 20:31:27', '2023-09-15 20:31:28'),
	(3, 3, 1987, 1909, 2021, '2023-09-15 20:31:58', '2023-09-15 20:31:59'),
	(4, 4, 2523, 2473, 2021, '2023-09-15 20:32:28', '2023-09-15 20:32:29'),
	(5, 5, 2156, 2120, 2021, '2023-09-15 20:32:51', '2023-09-15 20:32:52'),
	(6, 6, 3964, 3912, 2021, '2023-09-15 20:33:26', '2023-09-15 20:33:27'),
	(7, 7, 2514, 2455, 2021, '2023-09-15 20:33:54', '2023-09-15 20:33:55'),
	(8, 8, 2662, 2662, 2021, '2023-09-15 20:34:18', '2023-09-15 20:34:19'),
	(9, 9, 1907, 1893, 2021, '2023-09-15 20:34:43', '2023-09-15 20:34:44'),
	(10, 10, 1458, 1458, 2021, '2023-09-15 20:35:10', '2023-09-15 20:35:11'),
	(11, 11, 1712, 1712, 2021, '2023-09-15 20:35:29', '2023-09-15 20:35:30'),
	(12, 12, 1783, 1783, 2021, '2023-09-15 20:35:50', '2023-09-15 20:35:51'),
	(13, 13, 1536, 1478, 2021, '2023-09-15 20:36:21', '2023-09-15 20:36:22'),
	(14, 14, 2369, 2409, 2021, '2023-09-15 20:36:46', '2023-09-15 20:36:47'),
	(15, 15, 2063, 2051, 2021, '2023-09-15 20:37:16', '2023-09-15 20:37:16'),
	(16, 16, 982, 969, 2021, '2023-09-15 20:37:40', '2023-09-15 20:37:41'),
	(17, 17, 2415, 2382, 2021, '2023-09-15 20:38:07', '2023-09-15 20:38:08'),
	(18, 18, 498, 494, 2021, '2023-09-15 20:38:28', '2023-09-15 20:38:28'),
	(19, 19, 1144, 1119, 2021, '2023-09-15 20:38:49', '2023-09-15 20:38:49'),
	(20, 20, 712, 698, 2021, '2023-09-15 20:39:11', '2023-09-15 20:39:12');

-- Dumping structure for table datatables.bidang
...
-- Dumping data for table datatables.bidang: ~6 rows (approximately)
...
-- Dumping structure for table datatables.dataklasifikasi
...
-- Dumping data for table datatables.dataklasifikasi: ~40 rows (approximately)
...
-- Dumping structure for table datatables.data_siswa
...
-- Dumping data for table datatables.data_siswa: ~250 rows (approximately)
...
-- Dumping structure for table datatables.failed_jobs
...
-- Dumping data for table datatables.failed_jobs: ~0 rows (approximately)

-- Dumping structure for table datatables.imunisasi
...
-- Dumping data for table datatables.imunisasi: ~20 rows (approximately)
INSERT INTO `imunisasi` (`id`, `kecamatan_id`, `jk_lk`, `jk_pr`, `tahun`, `created_at`, `updated_at`) VALUES
	(1, 1, 175, 180, 2021, '2023-09-15 15:24:44', '2023-09-15 15:24:46'),
	(2, 2, 129, 145, 2021, '2023-09-15 15:25:13', '2023-09-15 15:25:14'),
	(3, 3, 167, 163, 2021, '2023-09-15 15:25:44', '2023-09-15 15:25:44'),
	(4, 4, 171, 145, 2021, '2023-09-15 15:26:00', '2023-09-15 15:26:01'),
	(5, 5, 58, 65, 2021, '2023-09-15 15:26:18', '2023-09-15 15:26:19'),
	(6, 6, 162, 168, 2021, '2023-09-15 15:26:54', '2023-09-15 15:26:55'),
	(7, 7, 83, 99, 2021, '2023-09-15 15:27:30', '2023-09-15 15:27:31'),
	(8, 8, 208, 197, 2021, '2023-09-15 15:30:25', '2023-09-15 15:30:26'),
	(9, 9, 226, 229, 2021, '2023-09-15 15:30:53', '2023-09-15 15:30:54'),
	(10, 10, 136, 105, 2021, '2023-09-15 15:31:23', '2023-09-15 15:31:24'),
	(11, 11, 37, 29, 2021, '2023-09-15 15:31:57', '2023-09-15 15:31:58'),
	(12, 12, 280, 247, 2021, '2023-09-15 15:32:21', '2023-09-15 15:32:22'),
	(13, 13, 216, 188, 2021, '2023-09-15 15:32:47', '2023-09-15 15:32:47'),
	(14, 14, 118, 104, 2021, '2023-09-15 15:33:55', '2023-09-15 15:33:56'),
	(15, 15, 257, 220, 2021, '2023-09-15 15:34:17', '2023-09-15 15:34:18'),
	(16, 16, 188, 206, 2021, '2023-09-15 15:34:41', '2023-09-15 15:34:42'),
	(17, 17, 106, 92, 2021, '2023-09-15 15:35:03', '2023-09-15 15:35:04'),
	(18, 18, 123, 122, 2021, '2023-09-15 15:35:23', '2023-09-15 15:35:25'),
	(19, 19, 318, 300, 2021, '2023-09-15 15:35:46', '2023-09-15 15:35:47'),
	(20, 20, 77, 72, 2021, '2023-09-15 15:36:11', '2023-09-15 15:36:12');

-- Dumping structure for table datatables.kecamatan
...
-- Dumping data for table datatables.kecamatan: ~20 rows (approximately)
...
-- Dumping structure for table datatables.kejarpaket
...
-- Dumping data for table datatables.kejarpaket: ~3 rows (approximately)
...
-- Dumping structure for table datatables.kelahiranbayi
CREATE TABLE IF NOT EXISTS `kelahiranbayi` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `kecamatan_id` tinyint unsigned NOT NULL,
  `jk_lk` int DEFAULT NULL,
  `jk_pr` int DEFAULT NULL,
...
-- Dumping data for table datatables.kelahiranbayi: ~20 rows (approximately)
INSERT INTO `kelahiranbayi` (`id`, `kecamatan_id`, `jk_lk`, `jk_pr`, `tahun`, `created_at`, `updated_at`) VALUES
	(1, 1, 258, 240, 2021, '2023-09-14 04:49:37', '2023-09-14 04:49:38'),
	(2, 2, 254, 248, 2021, '2023-09-14 04:49:52', NULL),
	(3, 3, 422, 356, 2021, '2023-09-14 07:29:00', '2023-09-14 07:29:04'),
	(4, 4, 415, 409, 2021, '2023-09-14 07:29:46', '2023-09-14 07:29:50'),
	(5, 5, 442, 377, 2021, '2023-09-14 07:30:39', '2023-09-14 07:30:41'),
	(6, 6, 713, 696, 2021, '2023-09-14 07:31:22', '2023-09-14 07:31:30'),
	(7, 7, 497, 430, 2021, '2023-09-14 07:32:19', '2023-09-14 07:32:22'),
	(8, 8, 514, 528, 2021, '2023-09-14 07:32:55', '2023-09-14 07:32:56'),
	(9, 9, 298, 348, 2021, '2023-09-14 07:33:26', '2023-09-14 07:33:29'),
	(10, 10, 264, 251, 2021, '2023-09-14 07:33:56', '2023-09-14 07:33:57'),
	(11, 11, 370, 323, 2021, '2023-09-14 07:34:23', '2023-09-14 07:34:24'),
	(12, 12, 362, 321, 2021, '2023-09-14 07:34:48', '2023-09-14 07:34:49'),
	(13, 13, 292, 261, 2021, '2023-09-14 07:35:19', '2023-09-14 07:35:21'),
	(14, 14, 473, 435, 2021, '2023-09-14 07:35:48', '2023-09-14 07:35:49'),
	(15, 15, 378, 374, 2021, '2023-09-14 07:36:20', '2023-09-14 07:36:21'),
	(16, 16, 187, 194, 2021, '2023-09-14 07:36:46', '2023-09-14 07:36:47'),
	(17, 17, 404, 387, 2021, '2023-09-14 07:37:11', '2023-09-14 07:37:12'),
	(18, 18, 59, 74, 2021, '2023-09-14 07:37:33', '2023-09-14 07:37:34'),
	(19, 19, 168, 171, 2021, '2023-09-14 07:37:57', '2023-09-14 07:37:58'),
	(20, 20, 107, 95, 2021, '2023-09-14 07:40:40', '2023-09-14 07:40:41');

-- Dumping structure for table datatables.klasifikasi
...
-- Dumping data for table datatables.klasifikasi: ~3 rows (approximately)
INSERT INTO `klasifikasi` (`id`, `namaklasifikasi`) VALUES
	(1, 'KELEMBAGAAN'),
	(2, 'TERPILAH'),
	(3, 'DASAR');

-- Dumping structure for table datatables.migrations
...
-- Dumping data for table datatables.migrations: ~28 rows (approximately)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(27, '2023_09_14_044334_create_kelahiranbayi_table', 8),
	(28, '2023_09_15_132210_create_balita_table', 9),
	(29, '2023_09_15_150441_create_imunisasi_table', 10);

-- Dumping structure for table datatables.password_resets
...
-- Dumping data for table datatables.password_resets: ~0 rows (approximately)

-- Dumping structure for table datatables.personal_access_tokens
...
-- Dumping data for table datatables.personal_access_tokens: ~0 rows (approximately)

-- Dumping structure for table datatables.sdnegeri
...
-- Dumping data for table datatables.sdnegeri: ~20 rows (approximately)
...
-- Dumping structure for table datatables.sdswasta
...
-- Dumping data for table datatables.sdswasta: ~20 rows (approximately)
...
-- Dumping structure for table datatables.sertifikasiguru
...
-- Dumping data for table datatables.sertifikasiguru: ~3 rows (approximately)
...
-- Dumping structure for table datatables.smpnegeri
...
-- Dumping data for table datatables.smpnegeri: ~20 rows (approximately)
...
-- Dumping structure for table datatables.smpswasta
...
-- Dumping data for table datatables.smpswasta: ~20 rows (approximately)
...
-- Dumping structure for table datatables.tbberita
...
-- Dumping data for table datatables.tbberita: ~0 rows (approximately)

-- Dumping structure for table datatables.users
...
-- Dumping data for table datatables.users: ~2 rows (approximately)
