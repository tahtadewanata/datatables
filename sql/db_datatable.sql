...
CREATE TABLE IF NOT EXISTS `dataklasifikasi` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `namadata` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table db_datatable.dataklasifikasi: ~38 rows (approximately)
INSERT INTO `dataklasifikasi` (`id`, `namadata`, `id_klasifikasi`, `id_bidang`, `created_at`, `updated_at`) VALUES
	(1, 'DATA PENDUDUK USIA SEKOLAH', 1, 1, NULL, NULL),
	(2, 'SISWA PUTUS SEKOLAH', 1, 1, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `klasifikasi` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `namaklasifikasi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping data for table db_datatable.migrations: ~20 rows (approximately)
...
-- Dumping data for table db_datatable.sdnegeri: ~5 rows (approximately)
INSERT INTO `sdnegeri` (`id`, `kecamatan_id`, `jk_lk`, `jk_pr`, `tahun`, `created_at`, `updated_at`) VALUES
	...
	(4, 4, 1875, 2031, 2021, NULL, NULL),
	(5, 5, 596, 646, 2021, NULL, NULL);
