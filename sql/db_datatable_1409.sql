...
--
-- Host: localhost:3306
-- Generation Time: Sep 14, 2023 at 06:54 AM
...
--
-- Table structure for table `dataklasifikasi`
--

CREATE TABLE `dataklasifikasi` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Dumping data for table `dataklasifikasi`
--
...
--
-- Table structure for table `kejarpaket`
--

CREATE TABLE `kejarpaket` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Dumping data for table `kejarpaket`
--
...
--
-- Table structure for table `kelahiranbayi`
--

CREATE TABLE `kelahiranbayi` (
  `id` int UNSIGNED NOT NULL,
  `kecamatan_id` tinyint UNSIGNED NOT NULL,
  `jk_lk` int DEFAULT NULL,
  `jk_pr` int DEFAULT NULL,
...
--
-- Dumping data for table `kelahiranbayi`
--
...
--
-- Table structure for table `sdnegeri`
--

CREATE TABLE `sdnegeri` (
  `id` bigint UNSIGNED NOT NULL,
  `kecamatan_id` tinyint UNSIGNED NOT NULL,
  `jk_lk` int DEFAULT NULL,
  `jk_pr` int DEFAULT NULL,
...
--
-- Dumping data for table `sdnegeri`
--
...
--
-- Table structure for table `sdswasta`
--

CREATE TABLE `sdswasta` (
  `id` bigint UNSIGNED NOT NULL,
  `kecamatan_id` bigint UNSIGNED NOT NULL,
  `jk_lk` int DEFAULT NULL,
  `jk_pr` int NOT NULL,
...
--
-- Dumping data for table `sdswasta`
--
...
--
-- Table structure for table `sertifikasiguru`
--

CREATE TABLE `sertifikasiguru` (
  `id` int UNSIGNED NOT NULL,
  `jenjang` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `jk_lk` int DEFAULT NULL,
  `jk_pr` int DEFAULT NULL,
...
--
-- Dumping data for table `sertifikasiguru`
--
...
--
-- Table structure for table `smpnegeri`
--

CREATE TABLE `smpnegeri` (
  `id` bigint UNSIGNED NOT NULL,
  `kecamatan_id` tinyint UNSIGNED NOT NULL,
  `jk_lk` int DEFAULT NULL,
  `jk_pr` int DEFAULT NULL,
...
--
-- Indexes for table `dataklasifikasi`
--
ALTER TABLE `dataklasifikasi`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `kejarpaket`
--
ALTER TABLE `kejarpaket`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `kelahiranbayi`
--
ALTER TABLE `kelahiranbayi`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `sdnegeri`
--
ALTER TABLE `sdnegeri`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sdswasta`
--
ALTER TABLE `sdswasta`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sertifikasiguru`
--
ALTER TABLE `sertifikasiguru`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `smpnegeri`
--
...
ALTER TABLE `tbberita`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `tbberita_slug_unique` (`slug`);
...
--
-- AUTO_INCREMENT for table `dataklasifikasi`
--
ALTER TABLE `dataklasifikasi`
...
--
-- AUTO_INCREMENT for table `kejarpaket`
--
ALTER TABLE `kejarpaket`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `kelahiranbayi`
--
ALTER TABLE `kelahiranbayi`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `sdnegeri`
--
ALTER TABLE `sdnegeri`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `sdswasta`
--
ALTER TABLE `sdswasta`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `sertifikasiguru`
--
ALTER TABLE `sertifikasiguru`
