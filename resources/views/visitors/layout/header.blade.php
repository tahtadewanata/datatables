...
================================================== -->
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?= URL('/'); ?>/storage/theme/images/favicon.png" />

    <!-- PLUGINS CSS STYLE -->
    <link rel="stylesheet" href="<?= URL('/'); ?>/storage/theme/plugins/bootstrap/bootstrap.min.css">
    <link rel="stylesheet" href="<?= URL('/'); ?>/storage/theme/plugins/themify-icons/themify-icons.css">
    <link rel="stylesheet" href="<?= URL('/'); ?>/storage/theme/plugins/slick/slick.css">
    <link rel="stylesheet" href="<?= URL('/'); ?>/storage/theme/plugins/slick/slick-theme.css">
    <link rel="stylesheet" href="<?= URL('/'); ?>/storage/theme/plugins/fancybox/jquery.fancybox.min.css">
    <link rel="stylesheet" href="<?= URL('/'); ?>/storage/theme/plugins/aos/aos.css">

    <!-- CUSTOM CSS -->
    <link href="<?= URL('/'); ?>/storage/theme/css/style.css" rel="stylesheet">
