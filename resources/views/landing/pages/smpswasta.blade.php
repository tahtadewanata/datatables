                        ...
                        <table id="exampleData" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="2">Jenis Kelamin SMP Swasta</th>
    ...
    <script>
        $(function() {
            ...
            $('#exampleFormControlSelect1').on('change', function() {
                ...
                let urls = '{!! route('getsmpswasta') !!}' + '?tahun=' + tahun;
        ...
        function downloadImage() {
            myChart.options.title.text = 'Judul Chart SMP SWASTA';
            myChart.update({
                duration: 0
            });
